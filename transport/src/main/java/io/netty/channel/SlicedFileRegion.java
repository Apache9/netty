 ...
 */
final class SlicedFileRegion extends AbstractFileRegion {

    private final AbstractFileRegion parent;

    private final long offset;

    private final long count;

    public SlicedFileRegion(AbstractFileRegion parent, long index, long count) {
    ...
    @Override
    public AbstractFileRegion unwrap() {
        return parent;
    }
